...
KNOWN_PREFIX = "User extended attributes: "
WARNING_PREFIX = "Non default extra attributes"
...
def test_extended_ok(
    ...
    cmd = f"vspec export json --pretty -u {TEST_UNITS} -q {TEST_QUANT} {extended_args} -s {TEST_FILE} -o {output}"
    ...
    if extended_warning:
        ...
        assert (WARNING_PREFIX + extended_warning) in process.stdout
